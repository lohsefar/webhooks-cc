...
schema: howto
keywords: ["test stripe webhooks", "stripe webhook testing", "stripe signature verification", "stripe webhook localhost"]
seo:
...
<Callout type="info">
You need a webhooks.cc API key from your [account page](/account) and a Stripe test-mode webhook secret.
</Callout>
