...
schema: howto
keywords:
  ["test webhooks locally", "localhost webhook testing", "webhook development", "webhook debugging"]
seo:
...
<Callout type="info">
  You need a webhooks.cc account and an API key from your [account page](/account). The free plan
  includes 50 requests per day, enough for local development.
</Callout>
