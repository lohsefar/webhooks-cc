...
schema: howto
keywords: ["test shopify webhooks", "shopify webhook testing", "shopify HMAC verification", "shopify webhook localhost"]
seo:
  ...
  it("handles custom order payloads", async () => {
    const res = await client.sendTo(WEBHOOK_URL, {
      ...
      body: {
        ...
        name: "#2001",
        line_items: [
          { id: 111222333, title: "Starter Plan", quantity: 1, price: "49.99" },
        ],
      },
    });
