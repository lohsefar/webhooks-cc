...
| **Slack**             | message, app_mention, slash_command                                | `application/json`                  | `x-slack-signature` (HMAC SHA-256 over v0:timestamp:body)                                                    |
| **Paddle**            | transaction.completed, subscription.created, subscription.canceled | `application/json`                  | `paddle-signature` (HMAC SHA-256 over timestamp:body)                                                        |
