...
|---|---|---|---|
| Supabase (Postgres) | REDACTED_HOST | 5433 (direct), 5432 (session pooler), 6543 (txn pooler) | Primary data store |
| Kong API Gateway | REDACTED_HOST | 8000 | PostgREST, Auth, Realtime |
...
- Integration tests run against the real Supabase dev instance at REDACTED_HOST
