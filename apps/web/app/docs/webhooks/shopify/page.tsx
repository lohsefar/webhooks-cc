  ...
  return (
    <article>
      ...
      <p className="text-lg text-muted-foreground mb-10">
        Capture Shopify webhooks for order events, product updates, and more during local development.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          Name it something like <code className="font-mono font-bold">Shopify Dev</code> and
          set the mock response to return <code className="font-mono font-bold">200 OK</code>.
          Shopify retries on non-2xx responses. Copy the generated URL from the URL bar.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          <strong className="text-foreground">Settings &rarr; Notifications &rarr; Webhooks</strong> (or use the
          Shopify API):
        </p>
    ...
    "format": "json"
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground">
          Create a test order in your Shopify development store. The webhook fires and appears in your
          webhooks.cc dashboard. Use the <strong className="text-foreground">Send test notification</strong>{" "}
          button in Shopify&apos;s webhook settings for a quick test.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground">
          ...
          <code className="font-mono font-bold">x-shopify-hmac-sha256</code> header is preserved when
          forwarding, so your local server can verify the signature using the raw request body.
        </p>
      </section>
    </article>
  );
