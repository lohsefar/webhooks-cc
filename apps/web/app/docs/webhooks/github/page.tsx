  ...
  return (
    <article>
      ...
      <p className="text-lg text-muted-foreground mb-10">
        Capture and test GitHub webhooks during development. Inspect push events, pull request
        actions, and more.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          <strong className="text-foreground">Settings &rarr; Webhooks &rarr; Add webhook</strong>:
        </p>
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          <li>
            <strong className="text-foreground">Payload URL:</strong> paste your endpoint URL (e.g.,{" "}
          ...
          <li>
            <strong className="text-foreground">Secret:</strong> your webhook secret (optional but
            recommended)
          </li>
          <li>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground mb-4">
          Push a commit, open a PR, or use the{" "}
          <strong className="text-foreground">Redeliver</strong> button on an existing delivery in
          GitHub&#39;s webhook settings. The event appears in your dashboard and is forwarded to
          your local server.
        </p>
      </section>
            ...
            <tbody>
              ...
              <tr className="border-b border-foreground/20">
                ...
                <td className="py-1.5 text-muted-foreground">
                  PR opened, closed, merged, or updated
                </td>
              </tr>
              <tr className="border-b border-foreground/20">
                <td className="py-1.5 pr-4">
