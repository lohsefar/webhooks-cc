    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 md:px-10">
        ...
        <div className="space-y-3 text-sm text-muted-foreground">
          <p>
            By using webhooks.cc, you agree to these terms. If you disagree with
        ...
        <section className="border-t-2 border-foreground pt-8 mt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              webhooks.cc lets you capture, inspect, and forward HTTP webhook
              requests for development and testing purposes.
            </p>
          </div>
        </section>
        ...
        <section className="border-t-2 border-foreground pt-8 mt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              You authenticate via GitHub or Google OAuth. You are responsible
              for all activity under your account and for keeping your
              credentials secure.
            </p>
          </div>
        </section>
        ...
        <section className="border-t-2 border-foreground pt-8 mt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              You are responsible for the data sent to your endpoints. Do not
              send sensitive information&mdash;passwords, payment card numbers,
              or personal health data&mdash;through the service. See our{" "}
              <Link
                href="/privacy"
        ...
        <section className="border-t-2 border-foreground pt-8 mt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              ...
              any kind. We do not guarantee uptime, and we may modify or
        ...
        <section className="border-t-2 border-foreground pt-8 mt-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              We may update these terms. We will update the date at the top of
              this page when we do. Continued use of the service after changes
